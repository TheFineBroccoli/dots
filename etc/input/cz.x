...
xkb_symbols "basic" {
    ...
    key <TLDE>  { [  semicolon, dead_abovering,  asciitilde,            grave ] };
    ...
    key <AD11>  { [      slash,     uacute,  bracketleft,     division ] };
    ...
    key <AC10>  { [   quotedbl,         dollar,      uring, NoSymbol ] };
    key <AC11>  { [     exclam,        section, apostrophe,   ssharp ] };
    key <AC12>  { [   EuroSign, dead_diaeresis,   NoSymbol, NoSymbol ] };
    key <BKSL>  { [ apostrophe, dead_diaeresis,  backslash,      bar ] };
